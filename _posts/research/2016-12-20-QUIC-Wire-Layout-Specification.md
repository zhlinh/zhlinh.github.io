...
- 丢失重传和拥塞控制: [draft-iyengar-quic-loss-recovery](https://tools.ietf.org/html/draft-tsvwg-quic-loss-recovery-01)
- 早期部署的QUIC标准化建议: [draft-hamilton-quic-transp](https://tools.ietf.org/html/draft-tsvwg-quic-protocol-02)
